...
sudo KUBECONFIG=/etc/rancher/k3s/k3s.yaml kubectl create configmap aws-global-env -n boutique-local \
  ...
  --from-literal=AWS_IP="10.10.10.55" \
  --from-literal=FRONTEND_ADDR="aiops-alb-819259145.ap-northeast-2.elb.amazonaws.com:8080" \
...
MASTER_INSTANCE_ID="i-0006971ef88a4f006"
